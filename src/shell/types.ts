/**
 * UI shell contracts. Partner: implement these and pass into MintokenApp
 * (or replace the default no-op handlers inside the component).
 */
    ...
    events: [
      {
        id: "evt-shell",
        source: "engine",
        summary: "UI shell ready. Wire Pioneer / Senso / Guild / Band / Replay behind this layout.",
      },
    ],
    memory: [],
    replay_marked: false,
